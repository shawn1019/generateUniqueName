...
import com.codepath.mypizza.GenerateUniqueNameHelper;
...
public class PizzaDetailFragment extends Fragment {
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    GenerateUniqueNameHelper.generate(view);//Generate unique names for visible widgets in PizzaDetailFragment.
  }
